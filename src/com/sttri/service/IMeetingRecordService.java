...
public interface IMeetingRecordService {
     ...
     * @return
     */
	public List<MeetingRecord> getResultList(String wherejpql,LinkedHashMap<String, String> orderby, Object... queryParams);
	
	/**
	 * 分页信息查询
	 * */
	public QueryResult<MeetingRecord> getScrollData(int firstindex,int maxresult, String wherejpql, Object[] queryParams,
